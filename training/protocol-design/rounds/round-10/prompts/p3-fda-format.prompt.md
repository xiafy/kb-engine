...
## Inputs
- FDA raw sections: `/Users/crohub/.openclaw/kb-engine/training/protocol-design/rounds/round-10/workspace/fda-raw-sections.md`
- Output path: `/Users/crohub/.openclaw/kb-engine/training/protocol-design/rounds/round-10/fda-actual.md`
- Case id: `kimmtrak`

## Rules
1. Use only `/Users/crohub/.openclaw/kb-engine/training/protocol-design/rounds/round-10/workspace/fda-raw-sections.md`.
...
## Output Schema
Write exactly this structure to `/Users/crohub/.openclaw/kb-engine/training/protocol-design/rounds/round-10/fda-actual.md`:
